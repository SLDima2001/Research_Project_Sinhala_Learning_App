...
export default function StorytellingScreen() {
    ...
    const renderItem = ({ item }: { item: any }) => (
        <TouchableOpacity
            ...
            onPress={() => router.push({ pathname: '/story/[id]', params: { id: item.id, title: item.title } })}
        >
            <ImageBackground
    ...
    return (
        <View style={styles.container}>
            ...
            <FlatList
                ...
                ListEmptyComponent={<Text style={{ textAlign: 'center', marginTop: 20 }}>No stories found.</Text>}
            />
        </View>
    );
}
